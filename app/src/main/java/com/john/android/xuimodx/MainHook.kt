                                                            ...
                                                            XposedHelpers.getObjectField(it.args[0], itemView)?.let { v ->
                                                                ...
                                                                XposedHelpers.getObjectField(it.args[0], holderRecyclerView)?.let { rv ->
                                                                    ...
                                                                    if (state != 0) // RecyclerView.SCROLL_STATE_IDLE
                                                                        v.startAnimation(ScaleAnimation(0.5f, 1f, 0.5f, 1f, ScaleAnimation.RELATIVE_TO_SELF, 0.5f, ScaleAnimation.RELATIVE_TO_SELF, 0.5f).apply {
                                                                            this.duration = 650
                                                                            this.interpolator = AnimationUtils.loadInterpolator(v?.context,17432585)
                                                                        })
                                                                }
                                                            }
                                                        } catch (e: Exception) {
